...
public final class Double extends Number
    ...
    public boolean equals(Object obj) {
        return (obj instanceof Double) && equ((Double)obj);
    }

    /**
     * Compares this object against the specified object.  The result
     * is {@code true} if and only if the argument has the same value as the
     * {@code double} represented by this object. For this
     * purpose, two {@code double} values are considered to be
     * the same if and only if the method {@link
     * #doubleToLongBits(double)} returns the identical
     ...
     * <p>Note that in most cases, for two instances of class
     * {@code Double}, {@code d1} and {@code d2}, the
     * value of {@code d1.equ(d2)} is {@code true} if and
     * only if
     *
     * <blockquote>
     *  {@code d1.doubleValue() == d2.doubleValue()}
     ...
     */
    @Override
    public boolean equ(Double obj) {
        return equ(obj.value, value);
    }

    /**
     * Compares the two specified {@code double} values. The result
     * is {@code true} if and only if the argument has the same value as the
     * {@code double} represented by this object. For this
     * purpose, two {@code double} values are considered to be
     * the same if and only if the method {@link #doubleToLongBits(double)}
